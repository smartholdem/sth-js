...
var smartholdem = require("../../index.js"); //lib
...
describe("slots.js", function () {
  ...
  describe("#getRealTime", function () {
    ...
    it("should return return real time, convert 10 to 1511269210000", function () {
      var d = 10;
      var real = getRealTime(d);
      (real).should.be.ok;
      (real).should.be.type("number").and.equal(1511269210000);
    });
  });
