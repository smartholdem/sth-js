...
describe("transaction.js", function () {
    ...
    var transaction = smartholdem.transaction;
    ...
    describe("#createTransaction", function () {
        ...
        it("should create transaction without second signature", function () {
            trs = createTransaction("SQjxubhNfRnXUAfD5p339iXBd6Vrt7rq6H", 1000, null, "secret");
            (trs).should.be.ok;
        });

        it("should create transaction without second signature from keys", function () {
            var secretKey = smartholdem.ECPair.fromSeed("secret");
            secretKey.publicKey = secretKey.getPublicKeyBuffer().toString("hex");

            trs = createTransaction("SQjxubhNfRnXUAfD5p339iXBd6Vrt7rq6H", 1000, null, secretKey);
            (trs).should.be.ok;
        });

        it("should create transaction with vendorField", function () {
            trs = createTransaction("SQjxubhNfRnXUAfD5p339iXBd6Vrt7rq6H", 1000, "this is a test vendorfield", "secret");
            (trs).should.be.ok;
        });
        ...
        it("should fail if transaction with vendorField length > 64", function () {
            ...
            vf = vf + "z";
            trs = createTransaction("SQjxubhNfRnXUAfD5p339iXBd6Vrt7rq6H", 1000, vf, "secret");
        ...
        describe("returned transaction", function () {
            ...
            it("should have recipientId as string and to be equal SQjxubhNfRnXUAfD5p339iXBd6Vrt7rq6H", function () {
                (trs.recipientId).should.be.type("string").and.equal("SQjxubhNfRnXUAfD5p339iXBd6Vrt7rq6H");
            });
            ...
            it("should be signed correctly", function () {
                var result = smartholdem.crypto.verify(trs);
                result.should.equal(true);
            });

            it("should be deserialised correctly", function () {
                var deserialisedTx = smartholdem.crypto.fromBytes(smartholdem.crypto.getBytes(trs).toString("hex"));
    ...
    describe("createTransaction and try to tamper signature", function () {
        ...
        it("should not validate overflown signatures", function () {
            ...
            var old_transaction = smartholdem.transaction.createTransaction('Sa9JKodiNeM7tbYjxwEhvvG1kBczhQxTN3', 1, null, 'randomstring');
            ...
            */
            ...
            // console.log("TXID " + smartholdem.crypto.getId(old_transaction));
            // console.log("VERIFY " + smartholdem.crypto.verify(old_transaction));
            // console.log("SIG " + old_transaction.signature + "\n");

            smartholdem.crypto.verify(old_transaction).should.equal(true);
            ...
            smartholdem.crypto.verify(old_transaction).should.equal(false);
    ...
    describe("#createTransaction with second secret", function () {
        ...
        var keys = smartholdem.crypto.getKeys(secondSecret);
        ...
        it("should create transaction without second signature", function () {
            trs = createTransaction("SQjxubhNfRnXUAfD5p339iXBd6Vrt7rq6H", 1000, null, "secret", secondSecret);
            (trs).should.be.ok;
        });
        ...
        describe("returned transaction", function () {
            ...
            it("should be second signed correctly", function () {
                var result = smartholdem.crypto.verifySecondSignature(trs, keys.publicKey);
                (result).should.equal(true);
            });
