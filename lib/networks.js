...
module.exports = {
    ...
    smartholdem: {
        ...
        peers: [
            ...
            { ip: '194.87.109.123', port: 6100 },
            { ip: '195.133.144.144', port: 6100 },
            { ip: '194.87.146.50', port: 6100 },
            { ip: '194.87.109.162', port: 6100 },
            { ip: '194.87.97.190', port: 6100 },
            { ip: '194.87.109.198', port: 6100 },
            { ip: '194.87.95.30', port: 6100 },
            { ip: '195.133.197.108', port: 6100 },
            { ip: '194.87.232.27', port: 6100 },
            { ip: '195.133.1.3', port: 6100 },
            { ip: '194.87.234.129', port: 6100 },
            { ip: '194.87.109.155', port: 6100 },
            ...
            { ip: '185.205.209.90', port: 6100 },
            { ip: '80.209.236.28', port: 6100 },
            { ip: '139.59.118.233', port: 6100 },
            { ip: '104.237.6.10', port: 6100 },
            { ip: '185.54.49.45', port: 6100 },
            { ip: '79.143.185.73', port: 6100 }
        ],
    },
    /** @type {Network} */
    testnet: {
